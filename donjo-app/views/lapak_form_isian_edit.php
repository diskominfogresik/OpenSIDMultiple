    ...
    <div class="box box-primary">
        <div class="box-body box-profile">
            ...
            <div class="input-group input-group-sm text-center">
                <input type="file" class="hidden" id="file" name="foto_lapak">
                <input type="text" class="hidden" id="file_path" name="foto_lapak">
...
<div class="col-md-9">
    <div class='box box-primary'>
        ...
        <div class='box-body'>
            <?php $this->load->view('lapak_form_isian_bersama_edit'); ?>
        </div>
