<div class="col-md-3">
    ...
    <div class="box box-primary">
        <div class="box-body box-profile">
            <img class="penduduk profile-user-img img-responsive img-circle" id="foto"src="<?= AmbilFoto($data["foto"]) ?>" alt="Foto">
            <br />
...
<div class="col-md-9">
    <div class='box box-primary'>
        ...
        <div class='box-body'>
            <?php $this->load->view('lapak/lapak_form_isian_bersama'); ?>
        </div>
