<div class="col-md-3">
    ...
    <div class="box box-primary">
        <div class="box-body box-profile">
            <img class="penduduk profile-user-img img-responsive img-circle" id="foto" src="<?= AmbilFotoLapak($lapak['foto_lapak']) ?>" alt="Foto">
            <br />
...
<div class="col-md-9">
    <div class='box box-primary'>
        ...
        <div class='box-body'>
            <?php $this->load->view('lapak/lapak_form_isian_bersama_edit'); ?>
        </div>

        <div class='box-footer'>
            <button  onclick="location.href='<?= site_url('lapak') ?>'" type='reset' class='btn btn-social btn-flat btn-danger btn-sm'><i class='fa fa-times'></i> Batal</button>
