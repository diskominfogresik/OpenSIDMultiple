<div class="tab-pane <?php if ($act_tab==8): ?>active<?php endif ?>">
											<div class="row">
												<div class="col-md-12">
													<div class="box-header with-border">
														<h3 class="box-title"><strong>Migrasi Database Ke OpenSID versi Kominfo</strong></h3>
													</div>
													<div class="box-body">
														<div class="row">
															<div class="col-sm-12">
																<form action="<?= $form_action?>" method="post" enctype="multipart/form-data" id="excell" class="form-horizontal">
																	<p>Proses ini untuk mengubah database SID ke struktur database OpenSID versi Kominfo.</p>
																				...
																				<td style="padding-top:20px;padding-bottom:10px;">
																					<div class="form-group">
																						<div class="col-sm-8 col-lg-4">
																							<a href="#" class="btn btn-block btn-danger btn-sm ajax"  title="Migrasi DB" onclick="document.getElementById('excell').submit();" data-toggle="modal" data-target="#loading" data-backdrop="false" data-keyboard="false"> <i class="fa fa-spin fa-refresh"></i> Migrasi Database Ke OpenSID Versi Kominfo</a>
																						</div>
																					</div>
