...
<div class="container<?php if(config_item('fluid') == 'y') : ?>-fluid<?php endif; ?> main-container blog-content">
    <div class="card mb-0">
			...
			<div id="carouselDeNatra" class="carousel slide" data-ride="carousel">
				<div class="carousel-inner">
					...
					<div class="carousel-item <?php echo ($active == true)?"active":"" ?>" data-artikel="<?php echo $gambar['id']?>" <?php if ($slider_gambar['sumber'] != 3): ?> onclick="location.href='<?='artikel/'.buat_slug($gambar); ?>'" <?php endif; ?>>
						<img style="max-height: 350px;" class="img-responsive cover img-thumbnail img-fluid opacity-100" src="<?php echo base_url().$slider_gambar['lokasi'].'sedang_'.$gambar['gambar']?>">
