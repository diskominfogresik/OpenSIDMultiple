	...
	<div class="card-header border-bottom">
		<div class="media">
			<div class="media-body">
				<h4 class="content-color-primary mb-0"><i class="material-icons icon-sm">assessment</i> <a href="<?= site_url("statistik/4")?>"> Statistik <?= ucwords($this->setting->sebutan_desa);?></a></h4>
			</div>
		</div>
	</div>
