                   			...
                   			<div class="media mb-2">
                   				<div class="media-body">
                   					<span class="font-weight-bold">
                   					    <a href="https://www.natairaya.desa.id/kode" rel="noopener noreferrer" target="_blank" ><i class="material-icons icon arrow">brightness_4</i> <span data-name="kota">...</span></a>
                   					</span>
                   				</div>
                   			</div>
