		...
		<div class="card-body">
			<div class="mb-0 content-color-secondary">
				...
				<a data-fancybox="gallery" href="<?= AmbilFotoArtikel($single_artikel['gambar'],'sedang') ?>">
					<img src="<?= AmbilFotoArtikel($single_artikel['gambar'],'sedang') ?>" width="<?php if ($single_artikel["isi"]=='<p>&nbsp;&nbsp;</p>') { print('100%'); } else { print('300px'); } ?>" style="float:left; margin:0 8px 4px 0;" class="cover img-fluid img-thumbnail opacity-100" />
				</a>
				<?php endif; ?>
				<div class="mb-2">
				...
				<a data-fancybox="gallery" href="<?= AmbilFotoArtikel($single_artikel['gambar1'],'sedang')?>">
					<img src="<?= AmbilFotoArtikel($single_artikel['gambar1'],'sedang')?>" class="img-responsive cover img-fluid img-thumbnail opacity-100" />
				</a>
				<?php endif; ?>
				...
				<a data-fancybox="gallery" href="<?= AmbilFotoArtikel($single_artikel['gambar2'],'sedang')?>">
					<img src="<?= AmbilFotoArtikel($single_artikel['gambar2'],'sedang')?>" class="img-responsive cover img-fluid img-thumbnail opacity-100 mt-2" />
				</a>
				<?php endif; ?>
				...
				<a data-fancybox="gallery" href="<?= AmbilFotoArtikel($single_artikel['gambar3'],'sedang')?>">
					<img src="<?= AmbilFotoArtikel($single_artikel['gambar3'],'sedang')?>" class="img-responsive cover img-fluid img-thumbnail opacity-100 mt-2" />
				</a>
				<?php endif; ?>
			</div>
		</div>
				...
				<form class="contact_form form-validasi" id="validasi" name="form" action="<?= site_url("add_comment/$single_artikel[id]"); ?>" method="POST" onSubmit="return validasi(this);">
					...
					<div class="row">
						<div class="col-12 col-lg-4 col-md-4 mb-2">
							<div class="input-group">
								<div class="input-group-prepend">
									<a href="#" onclick="document.getElementById('captcha').src = '<?= base_url()."securimage/securimage_show.php?"?>' + Math.random(); return false">
...
<?php else: ?>
<div class="card mb-3 fullscreen has-background-img ">
	<div class="card-header border-bottom">
		<div class="media">
			<div class="icon-circle icon-40 bg-light-primary mr-3">
				<i class="material-icons">business</i>
	...
	<div class="card-body">
		<div class="mb-0 content-color-secondary">
			<p>Maaf, halaman ini belum tersedia atau sedang dalam perbaikan</p>
			<p>Silahkan kembali lagi ke halaman <a href="<?= site_url(); ?>first">Beranda.</p>
		</div>
	</div>
</div>
<?php endif; ?>
<?php if($single_artikel["id"]): ?>
<?php $this->load->view(Web_Controller::fallback_default($this->theme, '/partials/banner.php'));?>
<?php endif; ?>
