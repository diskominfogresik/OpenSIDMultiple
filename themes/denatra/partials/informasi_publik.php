...
<?php if($this->uri->segment(1) == 'informasi_publik'): ?>
...
<?php elseif($this->uri->segment(1) == 'peraturan_desa'): ?> 
	<?php $this->load->view(Web_Controller::fallback_default($this->theme, '/partials/peraturan_desa.php'));?>
<?php endif; ?>
