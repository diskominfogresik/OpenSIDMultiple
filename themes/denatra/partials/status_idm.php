				...
				<div class="card-header border-bottom">
                    <div class="media">
                    	...
                    	<div class="media-body">
                    		<h6 class="my-0 content-color-primary"><a href="#">Status IDM <?= $idm->SUMMARIES->TAHUN ?></a></h6>
                    		<p class="small mb-0">
				...
				<div class="card-body">
                    <div class="row">
                    	<div class="col-sm-12">
                    		...
                    		<?php endif; ?>
                    		<div class="row">
                    			<div class="col-6 col-lg-3 col-md-3 status-idm-kiri">
                    			...
                    			<div class="col-6 col-lg-3 col-md-3 status-idm-kiri status-idm-kanan">
                    			...
                    			<div class="col-6 col-lg-3 col-md-3 status-idm-kanan">
