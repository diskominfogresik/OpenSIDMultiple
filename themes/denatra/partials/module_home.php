...
<div class="row">
	<div class="container-fluid mt-0 main-container z-index-1">
		<div class="row no-gutters box-shadow-large mb-2 bg-white rounded has-background-img mt-0">
			...
			<div class="col-12 col-md-6 col-lg-5 card mb-0 fullscreen">
				...
				<div class="card-body text-center">
					...
					<?php if (file_exists('donjo-app/views/lapak_admin')): ?>
					<button type="button" class="btn btn-danger btn-block mb-2" data-toggle="modal" data-target="#pendapat" >KELUAR</button>
					<?php else: ?>
					<a href="<?= site_url('layanan-mandiri/keluar'); ?>" class="btn btn-danger btn-block mb-2">KELUAR</a>
					<?php endif; ?>
				</div>
				<?php endif; ?>
			</div>
