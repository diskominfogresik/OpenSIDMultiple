    ...
    <div class="card-header border-bottom">
        <div class="media">
            ...
            <div class="media-body">
                <h6 class="my-0 content-color-primary"><?= $parrent['nama'] ?></h6>
				<p class="small mb-0">
					<i class="material-icons icon-sm">date_range</i> Galeri Album
				</p>
			</div>
			<a class="btn btn-sm btn-purple pink-gradient" href="<?= site_url('first/gallery') ?>" style="float: right;">Kembali</a>
		</div>
	</div>
	<div class="card-body">
		<?php if ($gallery): ?>
		...
		<?php $data['paging_page'] = 'first/sub_gallery'; ?>
